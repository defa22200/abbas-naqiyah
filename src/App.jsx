...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-clip text-ink antialiased">
      ...
      {!isCeremonyDone && <EnvelopeCeremony onComplete={handleCeremonyComplete} />}
      ...
      <main className="relative z-10 max-w-xl mx-auto px-4 sm:px-6 pt-6 sm:pt-12 pb-28 sm:pb-32">
